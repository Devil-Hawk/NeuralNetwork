...
class CIFAR10_CNN(nn.Module):
    ...
    def create_features(self):
        return nn.Sequential(
            nn.Conv2d(3, 9, kernel_size=3, padding=1), nn.ReLU(),
            nn.Conv2d(9, 9, kernel_size=3, padding=1), nn.ReLU(),
            nn.MaxPool2d(2, 2),
            nn.Conv2d(9, 18, kernel_size=3, padding=1), nn.ReLU(),
            nn.Conv2d(18, 18, kernel_size=3, padding=1), nn.ReLU(),
            nn.MaxPool2d(2, 2),
            nn.Conv2d(18, 36, kernel_size=3, padding=1), nn.ReLU(),
